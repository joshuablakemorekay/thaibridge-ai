...
- 🔊 **Tones & Consonant Classes** *(new)* — a unified section (Basic tier) that teaches the three consonant classes and the tone rules together (they're really one skill), with four progressive practice drills that plug into the same points-and-levels engine as everything else
