...
| 84 | IMG_0348 | 264 |
| 85 | IMG_0349 | 264 |
| **86** | **IMG_0351** | **265** ⟵ offset changes here |
| 87 | IMG_0352 | 265 |
| 88 | IMG_0353 | 265 |
| 89 | IMG_0354 | 265 |
| 90 | IMG_0355 | 265 |
...
read the same way, as were pages 77 to 85, and are `IMG_0339` to `IMG_0349`,
so the offset of 264 held for twelve pages — and then BREAKS AGAIN at page 86.
`IMG_0350` does not exist (it is already in the deleted-duplicate list below), so
page 86 is `IMG_0351` and the offset steps to **265**. That is the SECOND of the
seven changes this table predicted; five are still to come before page 207.
