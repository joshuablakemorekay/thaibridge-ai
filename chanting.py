...
'id': 'tangkhanika-paccavekkhana-patho',
    ...
    },
    {
        ...
        'closing': {
            'pali': 'มะหาโมคคัลลานะโพชฌังคะสุตตัง นิฏฐิตัง',
            'pali_roman': 'mahāmoggallānabojjhaṅgasuttaṃ niṭṭhitaṃ',
            'thai': '',
            'paiboon': '',
            'english': 'Here ends the Discourse on the Factors of Awakening, to Mahāmoggallāna.',
        },
        'verses': [
            {
                'number': 1,
            ...
            #   where the Mahakassapa version on page 33 prints one.
            #   Reproduced as printed on each page rather than made to agree.
            {
                ...
                'thai': '',
                'paiboon': '',
                'english': 'Then the Blessed One, rising from seclusion towards evening, went to where the venerable Mahāmoggallāna was;',
            },
            {
                'number': 5,
                'page': 35,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'having gone there, he sat down on the seat made ready,',
            },
            {
                'number': 6,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'and seated, the Blessed One said this to the venerable Mahāmoggallāna.',
            },
            {
                'number': 7,
                'pali': 'กัจจิ เต โมคคัลลานะ ขะมะนียัง,',
                'pali_roman': 'kacci te moggallāna khamanīyaṃ,',
                'thai': '',
                'paiboon': '',
                'english': '"Moggallāna, is it bearable for you,',
            },
            {
                'number': 8,
                'pali': 'กัจจิ ยาปะนียัง,',
                'pali_roman': 'kacci yāpanīyaṃ,',
                'thai': '',
                'paiboon': '',
                'english': 'can you keep going,',
            },
            {
                'number': 9,
                'pali': 'กัจจิ ทุกขา เวทะนา ปะฏิกกะมันติ, โน อะภิกกะมันติ,',
                ...
                'thai': '',
                'paiboon': '',
                'english': 'are the painful feelings receding and not increasing,',
            },
            # ‼ CHECK [IMG_0298.PNG]: The book prints no full stop after โน
            #   อะภิกกะโมติ — the Buddha's question runs straight into
            #   Moggallana's reply with no punctuation between them. The
            #   Mahakassapa version on page 33 does print a stop there.
            #   Reproduced as printed; the verse break is mine, at the change
            #   of speaker.
            {
                'number': 10,
                'pali': 'ปะฏิกกะโมสานัง ปัญญายะติ, โน อะภิกกะโมติ',
                ...
                'thai': '',
                'paiboon': '',
                'english': 'is their easing apparent and not their worsening?"',
            },
            {
                'number': 11,
                'pali': 'นะ เม ภันเต ขะมะนียัง, นะ ยาปะนียัง,',
                ...
                'thai': '',
                'paiboon': '',
                'english': '"Venerable sir, it is not bearable for me, I cannot keep going,',
            },
            {
                'number': 12,
                'pali': 'พาฬ์หา เม ทุกขา เวทะนา อะภิกกะมันติ, โน ปะฏิกกะมันติ,',
                ...
                'thai': '',
                'paiboon': '',
                'english': 'my painful feelings are severe and increasing, not receding,',
            },
            {
                'number': 13,
                'pali': 'อะภิกกะโมสานัง ปัญญายะติ, โน ปะฏิกกะโมติ.',
                ...
                'thai': '',
                'paiboon': '',
                'english': 'their worsening is apparent, not their easing."',
            },
            {
                'number': 14,
                'pali': 'สัตติเม โมคคัลลานะ โพชฌังคา มะยา สัมมะทักขาตา ภาวิตา พะหุลีกะตา, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตันติ.',
                'pali_roman': 'sattime moggallāna bojjhaṅgā mayā sammadakkhātā bhāvitā bahulīkatā, abhiññāya sambodhāya nibbānāya saṃvattanti.',
                'thai': '',
                'paiboon': '',
                'english': '"Moggallāna, these seven factors of awakening, rightly declared by me, developed and made much of, lead to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 15,
                'pali': 'กะตะเม สัตตะ.',
            ...
            },
            {
                'number': 16,
                'printed_number': 1,
                'pali': 'สะติสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'satisambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': '"The factor of awakening that is mindfulness, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 17,
                'printed_number': 2,
                'pali': 'ธัมมะวิจะยะสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'dhammavicayasambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is investigation of states, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 18,
                'printed_number': 3,
                'pali': 'วิริยะสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'vīriyasambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is energy, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 19,
                'printed_number': 4,
                'pali': 'ปีติสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'pītisambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is rapture, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 20,
                'printed_number': 5,
                'pali': 'ปัสสัทธิสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'passaddhisambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is tranquillity, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 21,
                'printed_number': 6,
                'pali': 'สะมาธิสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'samādhisambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is concentration, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 22,
                'printed_number': 7,
                'pali': 'อุเปกขาสัมโพชฌังโค โข โมคคัลลานะ มะยา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'upekkhāsambojjhaṅgo kho moggallāna mayā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is equanimity, Moggallāna, rightly declared by me, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 23,
                'pali': 'อิเม โข โมคคัลลานะ สัตตะ โพชฌังคา มะยา สัมมะทักขาตา ภาวิตา พะหุลีกะตา, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตันตีติ.',
                'pali_roman': 'ime kho moggallāna satta bojjhaṅgā mayā sammadakkhātā bhāvitā bahulīkatā, abhiññāya sambodhāya nibbānāya saṃvattantīti.',
                'thai': '',
                'paiboon': '',
                'english': 'These seven factors of awakening, Moggallāna, rightly declared by me, developed and made much of, lead to direct knowledge, to full awakening, to Nibbāna."',
            },
            # ‼ CHECK [IMG_0298.PNG]: This page prints a comma in ตัคฆะ ภะคะวา
            #   โพชฌังคา, ตัคฆะ สุคะตะ where page 34's identical line has
            #   none. Reproduced as printed on each.
            {
                'number': 24,
                'pali': 'ตัคฆะ ภะคะวา โพชฌังคา, ตัคฆะ สุคะตะ โพชฌังคาติ.',
                'pali_roman': 'taggha bhagavā bojjhaṅgā, taggha sugata bojjhaṅgāti.',
            ...
            # ‼ CHECK [IMG_0299.PNG]: The book ends this sentence with ฯ where
            #   page 34's identical sentence ends with a full stop. Reproduced
            #   as printed.
            {
                'number': 25,
                'page': 36,
                'pali': 'อิทะมะโวจะ ภะคะวา ฯ',
                'pali_roman': 'idamavoca bhagavā.',
                'thai': '',
                'paiboon': '',
                'english': 'This the Blessed One said.',
            },
            {
                ...
                'thai': '',
                'paiboon': '',
                'english': 'Gladdened, the venerable Mahāmoggallāna delighted in the words of the Blessed One.',
            },
            {
                'number': 27,
                ...
                'thai': '',
                'paiboon': '',
                'english': "And the venerable Mahāmoggallāna rose up from that illness, and in that way the venerable Mahāmoggallāna's illness was abandoned.",
            },
        ],
    },
    {
        # ‼ COMMENTARY PENDING: set DATA-ONLY. background, meaning, summary,
        #   when_chanted and source still to be written. Verses are complete.
        # ‼ CHECK [IMG_0300.PNG]: The footnote marker 1 sits on the last word
        #   of verse 21, and the footnote under the rule reads ที.ปา 11/209.
        #   Filed as source_printed because it is a canonical citation, not an
        #   instruction to the chanter. Reproduced verbatim including the
        #   spacing; it is not expanded.
        # ‼ CHECK [IMG_0300.PNG]: The centred closing line has NO full stop
        #   after นิฏฐิตัง, matching page 36 and differing from page 34.
        # ‼ CHECK [IMG_0300.PNG]: Only the top third of page 37 carries text.
        #   The rest is blank apart from show-through from the reverse of the
        #   sheet, which was not read. Recorded so the page view knows the
        #   page is short rather than incomplete.
        # ‼ CHECK [IMG_0299.PNG]: No Thai translation is printed, so
        #   english_unverified is true and the English is a working
        #   translation made for this edition.
        'id': 'mahacunda-bojjhanga-suttam',
        'title_thai': 'มะหาจุนทะโพชฌังคะสุตตัง',
        'title_pali': 'Mahācundabojjhaṅgasuttaṃ',
        'title_roman': '',
        'title_english': 'The Discourse on the Factors of Awakening, to Mahācunda',
        'book_number': 19,
        'page_start': 36,
        'layout': 'prose',
        ...
        'closing': {
            'pali': 'มะหาจุนทะโพชฌังคะสุตตัง นิฏฐิตัง',
            'pali_roman': 'mahācundabojjhaṅgasuttaṃ niṭṭhitaṃ',
            'thai': '',
            'paiboon': '',
            'english': 'Here ends the Discourse on the Factors of Awakening, to Mahācunda.',
        },
        'verses': [
            {
                'number': 1,
            ...
            # ‼ CHECK [IMG_0299.PNG]: The book prints a full stop after
            #   ราชะคะเห วิหะระติ where the two sibling discourses on pages 33
            #   and 34 print a comma. Reproduced as printed, but kept as one
            #   verse because it is one statement of place — the verse break
            #   follows the sense, not the stop.
            {
                'number': 2,
                'pali': 'เอกัง สะมะยัง ภะคะวา, ราชะคะเห วิหะระติ. เวฬุวะเน กะลันทะกะนิวาเป.',
                'pali_roman': 'ekaṃ samayaṃ bhagavā, rājagahe viharati. veḷuvane kalandakanivāpe.',
            ...
            },
            {
                ...
                'thai': '',
                'paiboon': '',
                'english': 'Now at that time the Blessed One was afflicted, suffering, gravely ill.',
            },
            {
                'number': 4,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'Then the venerable Mahācunda, rising from seclusion towards evening, went to where the Blessed One was;',
            },
            {
                'number': 5,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'having gone there, he paid homage to the Blessed One and sat down to one side.',
            },
            {
                'number': 6,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'To the venerable Mahācunda, seated to one side, the Blessed One said this.',
            },
            {
                'number': 7,
                'pali': 'ปะฏิภันตุ ตัง จุนทะ โพชฌังคาติ.',
                'pali_roman': 'paṭibhantu taṃ cunda bojjhaṅgāti.',
                'thai': '',
                'paiboon': '',
                'english': '"Let the factors of awakening come to mind for you, Cunda."',
            },
            {
                'number': 8,
                'pali': 'สัตติเม ภันเต โพชฌังคา ภะคะวะตา สัมมะทักขาตา ภาวิตา พะหุลีกะตา, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตันติ.',
                'pali_roman': 'sattime bhante bojjhaṅgā bhagavatā sammadakkhātā bhāvitā bahulīkatā, abhiññāya sambodhāya nibbānāya saṃvattanti.',
                'thai': '',
                'paiboon': '',
                'english': '"Venerable sir, these seven factors of awakening, rightly declared by the Blessed One, developed and made much of, lead to direct knowledge, to full awakening, to Nibbāna.',
            },
            # ‼ CHECK [IMG_0299.PNG]: กะตะเม สัตตะ carries NO full stop here,
            #   where the same words on pages 33 and 35 do. Reproduced as
            #   printed.
            {
                'number': 9,
                'pali': 'กะตะเม สัตตะ',
            ...
            },
            {
                'number': 10,
                'printed_number': 1,
                'pali': 'สะติสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'satisambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': '"The factor of awakening that is mindfulness, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 11,
                'printed_number': 2,
                'pali': 'ธัมมะวิจะยะสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'dhammavicayasambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is investigation of states, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 12,
                'printed_number': 3,
                'pali': 'วิริยะสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'vīriyasambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is energy, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 13,
                'printed_number': 4,
                'pali': 'ปีติสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'pītisambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is rapture, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 14,
                'printed_number': 5,
                'pali': 'ปัสสัทธิสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'passaddhisambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is tranquillity, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 15,
                'printed_number': 6,
                'pali': 'สะมาธิสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'samādhisambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is concentration, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 16,
                'page': 37,
                'printed_number': 7,
                'pali': 'อุเปกขาสัมโพชฌังโค โข ภันเต ภะคะวะตา สัมมะทักขาโต ภาวิโต พะหุลีกะโต, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตะติ.',
                'pali_roman': 'upekkhāsambojjhaṅgo kho bhante bhagavatā sammadakkhāto bhāvito bahulīkato, abhiññāya sambodhāya nibbānāya saṃvattati.',
                'thai': '',
                'paiboon': '',
                'english': 'The factor of awakening that is equanimity, venerable sir, rightly declared by the Blessed One, developed and made much of, leads to direct knowledge, to full awakening, to Nibbāna.',
            },
            {
                'number': 17,
                'pali': 'อิเม โข ภันเต สัตตะ โพชฌังคา ภะคะวะตา สัมมะทักขาตา ภาวิตา พะหุลีกะตา, อะภิญญายะ สัมโพธายะ นิพพานายะ สังวัตตันตีติ.',
                'pali_roman': 'ime kho bhante satta bojjhaṅgā bhagavatā sammadakkhātā bhāvitā bahulīkatā, abhiññāya sambodhāya nibbānāya saṃvattantīti.',
                'thai': '',
                'paiboon': '',
                'english': 'These seven factors of awakening, venerable sir, rightly declared by the Blessed One, developed and made much of, lead to direct knowledge, to full awakening, to Nibbāna."',
            },
            # ‼ CHECK [IMG_0300.PNG]: Both halves of this line read จุนทะ,
            #   where the sibling discourses vary the address (ภะคะวา then
            #   สุคะตะ). That is what the page prints and it fits this
            #   discourse, where it is the Buddha who is ill and Cunda who
            #   recites — but it is the kind of repetition a typesetter can
            #   introduce, so worth one look.
            {
                'number': 18,
                'pali': 'ตัคฆะ จุนทะ โพชฌังคา, ตัคฆะ จุนทะ โพชฌังคาติ.',
                'pali_roman': 'taggha cunda bojjhaṅgā, taggha cunda bojjhaṅgāti.',
                'thai': '',
                'paiboon': '',
                'english': '"Assuredly, Cunda, they are factors of awakening; assuredly, Cunda, they are factors of awakening."',
            },
            {
                'number': 19,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'This the venerable Mahācunda said.',
            },
            {
                'number': 20,
                'pali': 'สะมะนุญโญ สัตถา อะโหสิ.',
                'pali_roman': 'samanuñño satthā ahosi.',
                'thai': '',
                'paiboon': '',
                'english': 'The Teacher approved.',
            },
            {
                'number': 21,
                'pali': 'วุฏฐะหิ จะ ภะคะวา ตัมหา อาพาธา, ตะถาปะหีโน จะ ภะคะวะโต โส อาพาโธ อะโหสีติ.',
                'pali_roman': 'vuṭṭhahi ca bhagavā tamhā ābādhā, tathāpahīno ca bhagavato so ābādho ahosīti.',
                'thai': '',
                'paiboon': '',
                'english': "And the Blessed One rose up from that illness, and in that way the Blessed One's illness was abandoned.",
            },
        ],
    },
    {
        # ‼ COMMENTARY PENDING: set DATA-ONLY. background, meaning, summary,
        #   when_chanted and source still to be written. Verses are complete.
        # ‼ CHECK [IMG_0301.PNG]: TWO footnotes on this page, so
        #   source_printed is deliberately left off — a chant carries one
        #   printed source and neither of these is obviously it. Both are
        #   recorded as page blocks instead. Marker 1 sits on วัตถุส์มินติ at
        #   the end of verse 3 and reads สํ. มหา. 19/117-8; marker 2 sits on
        #   โหตีติ at the end of verse 9 and reads วิ. มหา. 1/1. Marker 2
        #   matches its passage (the Verañja opening of the Vinaya Mahāvagga).
        #   Marker 1 reads as a Saṃyutta reference against a pārājika text,
        #   which looks odd — reproduced verbatim, not corrected, and worth
        #   your eye.
        # ‼ CHECK [IMG_0301.PNG]: The centred heading สวดแจง names the whole
        #   service, not this chant, so it is a page block rather than part of
        #   the chant. The English given for it is mine and unverified.
        # ‼ CHECK [IMG_0301.PNG]: The closing จบพระวินัย is Thai, not Pali, so
        #   it is filed in the thai and paiboon fields with pali_roman empty —
        #   unlike the Pali จบ formulas earlier in the book.
        # ‼ CHECK [IMG_0301.PNG]: No Thai translation of the chant is printed,
        #   so english_unverified is true and every english line is a working
        #   translation made for this edition.
        'id': 'phra-winai-sangkhep',
        'title_thai': 'พระวินัยสังเขป',
        'title_pali': '',
        'title_roman': 'prá-wí-nai sǎŋ-kèep',
        'title_english': 'The Vinaya in summary',
        'book_number': 20,
        'page_start': 38,
        'layout': 'prose',
        'group': 'General chanting',
        ...
        'closing': {
            ...
            'pali_roman': '',
            'thai': 'จบพระวินัย',
            'paiboon': 'jòp prá-wí-nai',
            'english': 'Here ends the Vinaya.',
        },
        'verses': [
            {
                'number': 1,
                'pali': 'ยันเตนะ ภะคะวะตา ชานะตา ปัสสะตา อะระหะตา สัมมาสัมพุทเธนะ, ปะฐะมัง ปาราชิกัง กัตถะ ปัญญัตตันติ, เวสาลิยัง ปัญญัตตันติ.',
                'pali_roman': 'yantena bhagavatā jānatā passatā arahatā sammāsambuddhena, paṭhamaṃ pārājikaṃ kattha paññattanti, vesāliyaṃ paññattanti.',
                'thai': '',
                'paiboon': '',
                'english': 'By the Blessed One who knows and sees, the Worthy One, perfectly enlightened by himself — where was the first pārājika laid down? It was laid down at Vesālī.',
            },
            {
                'number': 2,
                'pali': 'กัง อารัพภาติ, สุทินนัง กะลันทะปุตตัง อารัพภาติ.',
                'pali_roman': 'kaṃ ārabbhāti, sudinnaṃ kalandaputtaṃ ārabbhāti.',
                'thai': '',
                'paiboon': '',
                'english': 'Concerning whom? Concerning Sudinna, son of Kalanda.',
            },
            {
                'number': 3,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'In what matter? In the matter of Sudinna, son of Kalanda, having engaged in sexual intercourse with his former wife.',
            },
            # ‼ CHECK [IMG_0301.PNG]: The book breaks นะเพรุปุจิมันทะ-มูเล
            #   across a line with a hyphen. Rejoined to นะเพรุปุจิมันทะมูเล
            #   and the hyphen dropped, because it is typesetting rather than
            #   spelling — confirmed by verse 5, where the same word is
            #   printed whole and unhyphenated within one line.
            {
                'number': 4,
                'pali': 'เตนะ สะมะเยนะ พุทโธ ภะคะวา เวรัญชายัง วิหะระติ นะเพรุปุจิมันทะมูเล มะหะตา ภิกขุสังเฆนะ สัทธิง ปัญจะมัตเตหิ ภิกขุสะเตหิ.',
                'pali_roman': 'tena samayena buddho bhagavā verañjāyaṃ viharati naḷerupucimandamūle mahatā bhikkhusaṅghena saddhiṃ pañcamattehi bhikkhusatehi.',
                'thai': '',
                'paiboon': '',
                'english': "At that time the Buddha, the Blessed One, was dwelling at Verañjā at the foot of Naḷeru's nimba tree, together with a great Sangha of some five hundred monks.",
            },
            {
                'number': 5,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'The brahmin of Verañjā heard: "The ascetic Gotama, sir, the Sakyan son gone forth from the Sakyan clan, is dwelling at Verañjā at the foot of Naḷeru\'s nimba tree, together with a great Sangha of some five hundred monks."',
            },
            {
                'number': 6,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'And this good report had gone abroad about Master Gotama: "So indeed is the Blessed One — worthy, perfectly enlightened by himself, accomplished in knowledge and conduct, well-farer, knower of the worlds, unsurpassed trainer of those to be tamed, teacher of gods and humans, the Awakened One, the Blessed One."',
            },
            # ‼ CHECK [IMG_0301.PNG]: สัสสะมะณะพ์ราห์ / มะณิง is broken across
            #   a line with NO hyphen at all. Rejoined to
            #   สัสสะมะณะพ์ราห์มะณิง. Worth confirming against the page, since
            #   a break with no hyphen is easier to mis-join than one with.
            {
                ...
                'thai': '',
                'paiboon': '',
                'english': 'He makes known this world with its gods, its Māras and its Brahmās, this generation with its ascetics and brahmins, its gods and humans, having realised it himself by direct knowledge.',
            },
            # ‼ CHECK [IMG_0301.PNG]: ปะริโย-สานะกัล์ยาณัง carries a hyphen in
            #   the MIDDLE of a line, not at a line break, so it has been
            #   kept. That makes it different in kind from the two rejoined
            #   words above. If the book means it as one word throughout, this
            #   hyphen should come out — but that is a call about the
            #   printing, so it is reproduced as it stands.
            {
                ...
                'thai': '',
                'paiboon': '',
                'english': 'He teaches the Dhamma that is good in the beginning, good in the middle, good in the end, with its meaning and its wording; he makes known the holy life, complete and pure in its entirety.',
            },
            {
                'number': 9,
                'pali': 'สาธุ โข ปะนะ ตะถารูปานัง อะระหะตัง ทัสสะนัง โหตีติ.',
                'pali_roman': 'sādhu kho pana tathārūpānaṃ arahataṃ dassanaṃ hotīti.',
                'thai': '',
                'paiboon': '',
                'english': 'And good indeed it is to see such Worthy Ones.',
            },
        ],
    },
    {
        # ‼ COMMENTARY PENDING: set DATA-ONLY. background, meaning, summary,
        #   when_chanted and source still to be written. Verses are complete.
        # ‼ CHECK [IMG_0302.PNG]: This chant's title carries NO number, where
        #   the chants either side of it are numbered 20 and 21. book_number
        #   is therefore omitted rather than guessed. The book's own contents
        #   lists it as an entry in its own right, which is why it is set as a
        #   chant and not as part of chant 20.
        # ‼ CHECK [IMG_0302.PNG]: The footnote marker 1 sits on the last word
        #   of verse 4 and reads ที. สี. 9/1 — a canonical citation, so filed
        #   as source_printed. Reproduced verbatim including the spacing.
        # ‼ CHECK [IMG_0302.PNG]: No Thai translation is printed, so
        #   english_unverified is true and the English is a working
        #   translation made for this edition.
        'id': 'phra-sut-sangkhep',
        'title_thai': 'พระสูตรสังเขป',
        'title_pali': '',
        'title_roman': 'prá-sùut sǎŋ-kèep',
        'title_english': 'The Suttas in summary',
        'page_start': 39,
        'layout': 'prose',
        'source_printed': 'ที. สี. 9/1',
        'group': 'General chanting',
        'english_unverified': True,
        'invitation': {
            'pali': '',
        ...
        'closing': {
            ...
            'pali_roman': '',
            'thai': 'จบพระสูตร',
            'paiboon': 'jòp prá-sùut',
            'english': 'Here ends the Sutta.',
        },
        'verses': [
            # ‼ CHECK [IMG_0302.PNG]: The book ends เอวัมเม สุตัง with ฯ here,
            #   where the three Bojjhanga discourses on pages 33 to 36 print a
            #   full stop. Reproduced as printed.
            {
                'number': 1,
                'pali': 'เอวัมเม สุตัง ฯ เอกัง สะมะยัง ภะคะวา, อันตะรา จะ ราชะคะหัง อันตะรา จะ นาลันทัง อัทธานะมัคคะปะฏิปันโน โหติ มะหะตา ภิกขุสังเฆนะ สัทธิง ปัญจะมัตเตหิ ภิกขุสะเตหิ.',
                'pali_roman': 'evamme sutaṃ. ekaṃ samayaṃ bhagavā, antarā ca rājagahaṃ antarā ca nāḷandaṃ addhānamaggapaṭipanno hoti mahatā bhikkhusaṅghena saddhiṃ pañcamattehi bhikkhusatehi.',
                'thai': '',
                'paiboon': '',
                'english': 'Thus have I heard. At one time the Blessed One was travelling along the high road between Rājagaha and Nāḷandā, together with a great Sangha of some five hundred monks.',
            },
            {
                'number': 2,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'The wanderer Suppiya too was travelling along the high road between Rājagaha and Nāḷandā, together with his pupil, the youth Brahmadatta.',
            },
            # ‼ CHECK [IMG_0302.PNG]: อะเนกะ-ปะริยาเยนะ is broken across a
            #   line with a hyphen. Rejoined to อะเนกะปะริยาเยนะ and the
            #   hyphen dropped — confirmed by its second occurrence later in
            #   the same verse, printed whole within one line.
            {
                ...
                'thai': '',
                'paiboon': '',
                'english': "There the wanderer Suppiya spoke in many ways in dispraise of the Buddha, in dispraise of the Dhamma, in dispraise of the Sangha; while Suppiya's pupil, the youth Brahmadatta, spoke in many ways in praise of the Buddha, in praise of the Dhamma, in praise of the Sangha.",
            },
            # ‼ CHECK [IMG_0302.PNG]: อัญญะ-มัญญัสสะ is broken across a line
            #   with a hyphen. Rejoined to อัญญะมัญญัสสะ. Unlike the word
            #   above there is no second occurrence to confirm it against, so
            #   this one is worth checking.
            {
                'number': 4,
                'pali': 'อิติหะ เต อุโภ อาจะริยันเตวาสี อัญญะมัญญัสสะ อุชุวิปัจจะนิกะวาทา ภะคะวันตัง ปิฏฐิโต ปิฏฐิโต อะนุพันธา โหนติ ภิกขุสังฆัญจะ.',
                'pali_roman': 'itiha te ubho ācariyantevāsī aññamaññassa ujuvipaccanikavādā bhagavantaṃ piṭṭhito piṭṭhito anubandhā honti bhikkhusaṅghañca.',
                'thai': '',
                'paiboon': '',
                'english': 'So these two, teacher and pupil, contradicting each other outright, followed close behind the Blessed One and the Sangha of monks.',
            },
        ],
    },
    {
        # ‼ COMMENTARY PENDING: set DATA-ONLY. background, meaning, summary,
        #   when_chanted and source still to be written. Verses are complete.
        # ‼ CHECK [IMG_0302.PNG]: The whole passage carries ONE full stop, at
        #   the very end. Every other break in it is a comma, so the eight
        #   verses here are my clause divisions, not the book's punctuation.
        #   The book view reflows them into the single justified block the
        #   page prints, so the page is unaffected; the study view is where
        #   the division shows.
        # ‼ CHECK [IMG_0302.PNG]: The centred 21. พระอภิธรรมสังเขป above this
        #   chant is a SECTION heading covering all seven Abhidhamma books,
        #   not this chant's title — the book's own contents lists it as a
        #   section and lists พระสังคะณี separately as an entry. It is
        #   therefore a page block and this chant carries no book_number.
        # ‼ CHECK [IMG_0302.PNG]: No Thai translation is printed, so
        #   english_unverified is true and the English is a working
        #   translation.
        'id': 'phra-sangkhani',
        'title_thai': 'พระสังคะณี',
        'title_pali': '',
        'title_roman': 'prá-sǎŋ-ká-nii',
        'title_english': 'The Dhammasaṅgaṇī',
        'page_start': 39,
        'layout': 'prose',
        'group': 'General chanting',
        'english_unverified': True,
        ...
        'closing': {
            ...
            'pali_roman': '',
            'thai': 'จบพระสังคะณี',
            'paiboon': 'jòp prá-sǎŋ-ká-nii',
            'english': 'Here ends the Dhammasaṅgaṇī.',
        },
        'verses': [
            {
                'number': 1,
                'pali': 'กุสะลา ธัมมา,',
                'pali_roman': 'kusalā dhammā,',
                'thai': '',
                'paiboon': '',
                'english': 'Wholesome states,',
            },
            {
                'number': 2,
                'pali': 'อะกุสะลา ธัมมา,',
                'pali_roman': 'akusalā dhammā,',
                'thai': '',
                'paiboon': '',
                'english': 'unwholesome states,',
            },
            {
                'number': 3,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'indeterminate states.',
            },
            {
                'number': 4,
                'pali': 'กะตะเม ธัมมา กุสะลา,',
                'pali_roman': 'katame dhammā kusalā,',
                'thai': '',
                'paiboon': '',
                'english': 'Which states are wholesome?',
            },
            {
                'number': 5,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'On an occasion when a wholesome state of consciousness of the sense sphere has arisen, accompanied by gladness and associated with knowledge,',
            },
            {
                'number': 6,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'having as its object a form, or a sound, or an odour, or a taste, or a tangible, or a mental object, or whatever else it may be — on that occasion there is contact, there is undistractedness, and whatever else there is on that occasion,',
            },
            {
                'number': 7,
                'pali': 'อัญเญปิ อัตถิ ปะฏิจจะสะมุปปันนา, อะรูปิโน ธัมมา,',
                'pali_roman': 'aññepi atthi paṭiccasamuppannā, arūpino dhammā,',
                'thai': '',
                'paiboon': '',
                'english': 'other dependently arisen immaterial states —',
            },
            {
                'number': 8,
                'pali': 'อิเม ธัมมา กุสะลา.',
                'pali_roman': 'ime dhammā kusalā.',
                'thai': '',
                'paiboon': '',
                'english': 'these are wholesome states.',
            },
        ],
    },
    {
        ...
        #   translation.
        'id': 'phra-wiphang',
        'title_thai': 'พระวิภังค์',
        'title_pali': '',
        'title_roman': 'prá-wí-paŋ',
        'title_english': 'The Vibhaṅga',
        'page_start': 40,
        'layout': 'prose',
        'group': 'General chanting',
        'english_unverified': True,
        ...
        'closing': {
            ...
            'pali_roman': '',
            'thai': 'จบพระวิภังค์',
            'paiboon': 'jòp prá-wí-paŋ',
            'english': 'Here ends the Vibhaṅga.',
        },
        'verses': [
            {
                'number': 1,
                'pali': 'ปัญจักขันธา',
                'pali_roman': 'pañcakkhandhā',
                'thai': '',
                'paiboon': '',
                'english': 'The five aggregates:',
            },
            {
                'number': 2,
                'pali': 'รูปักขันโธ,',
                'pali_roman': 'rūpakkhandho,',
                'thai': '',
                'paiboon': '',
                'english': 'the aggregate of form,',
            },
            {
                'number': 3,
                'pali': 'เวทะนากขันโธ,',
                'pali_roman': 'vedanākkhandho,',
                'thai': '',
                'paiboon': '',
                'english': 'the aggregate of feeling,',
            },
            {
                'number': 4,
                'pali': 'สัญญากขันโธ,',
                'pali_roman': 'saññākkhandho,',
                'thai': '',
                'paiboon': '',
                'english': 'the aggregate of perception,',
            },
            {
                'number': 5,
                'pali': 'สังขารักขันโธ,',
                'pali_roman': 'saṅkhārakkhandho,',
                'thai': '',
                'paiboon': '',
                'english': 'the aggregate of formations,',
            },
            {
                'number': 6,
                'pali': 'วิญญาณักขันโธ.',
                'pali_roman': 'viññāṇakkhandho.',
                'thai': '',
                'paiboon': '',
                'english': 'the aggregate of consciousness.',
            },
            # ‼ CHECK [IMG_0303.PNG]: The question ตัตถะ กะตะโม รูปักขันโธ is
            #   printed with no punctuation at all — no full stop, no comma —
            #   running straight into the answer. Reproduced as printed; the
            #   verse break is mine, at the question.
            {
                'number': 7,
                'pali': 'ตัตถะ กะตะโม รูปักขันโธ',
                'pali_roman': 'tattha katamo rūpakkhandho',
                'thai': '',
                'paiboon': '',
                'english': 'Therein, which is the aggregate of form?',
            },
            {
                'number': 8,
                'pali': 'ยังกิญจิ รูปัง อะตีตานาคะตะปัจจุปปันนัง, อัชฌัตตัง วา พะหิทธา วา, โอฬาริกัง วา สุขุมัง วา, หีนัง วา ปะณีตัง วา, ยัง ทูเร วา สันติเก วา,',
                'pali_roman': 'yaṅkiñci rūpaṃ atītānāgatapaccuppannaṃ, ajjhattaṃ vā bahiddhā vā, oḷārikaṃ vā sukhumaṃ vā, hīnaṃ vā paṇītaṃ vā, yaṃ dūre vā santike vā,',
                'thai': '',
                'paiboon': '',
                'english': 'Whatever form there is, past, future or present, internal or external, gross or subtle, inferior or superior, far or near —',
            },
            {
                'number': 9,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'gathering all this together and comprising it as one, this is called the aggregate of form.',
            },
        ],
    },
    {
        ...
        # ‼ CHECK [IMG_0303.PNG]: No Thai translation is printed, so
        #   english_unverified is true and the English is a working
        #   translation. The paired terms here are technical Abhidhamma
        #   vocabulary and the English is a literal rendering, not a gloss of
        #   what the pairs mean.
        'id': 'phra-thatukatha',
        'title_thai': 'พระธาตุกะถา',
        'title_pali': '',
        'title_roman': 'prá-tâat-gà-tǎa',
        'title_english': 'The Dhātukathā',
        'page_start': 40,
        'layout': 'prose',
        'group': 'General chanting',
        'english_unverified': True,
        ...
        'closing': {
            ...
            'pali_roman': '',
            'thai': 'จบพระธาตุกะถา',
            'paiboon': 'jòp prá-tâat-gà-tǎa',
            'english': 'Here ends the Dhātukathā.',
        },
        'verses': [
            {
                'number': 1,
                'pali': 'สังคะโห อะสังคะโห.',
                'pali_roman': 'saṅgaho asaṅgaho.',
                'thai': '',
                'paiboon': '',
            ...
            {
                'number': 2,
                'pali': 'สังคะหิเตนะ อะสังคะหิตัง,',
                'pali_roman': 'saṅgahitena asaṅgahitaṃ,',
                'thai': '',
                'paiboon': '',
                'english': 'Not included by what is included,',
            },
            {
                'number': 3,
                'pali': 'อะสังคะหิเตนะ สังคะหิตัง,',
                'pali_roman': 'asaṅgahitena saṅgahitaṃ,',
                'thai': '',
                'paiboon': '',
                'english': 'included by what is not included,',
            },
            {
                'number': 4,
                'pali': 'สังคะหิเตนะ สังคะหิตัง,',
                'pali_roman': 'saṅgahitena saṅgahitaṃ,',
                'thai': '',
                'paiboon': '',
                'english': 'included by what is included,',
            },
            {
                'number': 5,
                'pali': 'อะสังคะหิเตนะ อะสังคะหิตัง,',
                'pali_roman': 'asaṅgahitena asaṅgahitaṃ,',
                'thai': '',
                'paiboon': '',
                'english': 'not included by what is not included,',
            },
            {
                'number': 6,
                'pali': 'สัมปะโยโค วิปปะโยโค,',
                'pali_roman': 'sampayogo vippayogo,',
                'thai': '',
                'paiboon': '',
                'english': 'association, dissociation,',
            },
            {
                'number': 7,
                'pali': 'สัมปะยุตเตนะ วิปปะยุตตัง,',
                'pali_roman': 'sampayuttena vippayuttaṃ,',
                'thai': '',
                'paiboon': '',
                'english': 'dissociated from what is associated,',
            },
            # ‼ CHECK [IMG_0303.PNG]: The last three words run together with
            #   no comma between สัมปะยุตตัง and อะสังคะหิตัง, unlike every
            #   pair before them. Kept as one verse because that is how the
            #   book runs them; if อะสังคะหิตัง is meant as a separate item
            #   the comma is missing from the printing.
            {
                'number': 8,
                'pali': 'วิปปะยุตเตนะ สัมปะยุตตัง อะสังคะหิตัง.',
                'pali_roman': 'vippayuttena sampayuttaṃ asaṅgahitaṃ.',
                'thai': '',
                'paiboon': '',
                'english': 'associated with what is dissociated, not included.',
            },
        ],
    },
    {
        # ‼ COMMENTARY PENDING: set DATA-ONLY. background, meaning, summary,
        #   when_chanted and source still to be written. Verses are complete.
        # ‼ CHECK [IMG_0303.PNG]: The footnote marker 1 sits on the last word
        #   of verse 18 and reads อภิ.ปุ. 36/1-2-3 — a canonical citation, so
        #   filed as source_printed. Reproduced verbatim, including the 1-2-3
        #   form, which is not expanded.
        # ‼ CHECK [IMG_0303.PNG]: No Thai translation is printed, so
        #   english_unverified is true. These are technical person-types and
        #   the English is a literal rendering rather than a settled
        #   translation.
        'id': 'phra-pukkhalabanyat',
        'title_thai': 'พระปุคคะละบัญญัติ',
        'title_pali': '',
        'title_roman': 'prá-púk-ká-lá-ban-yàt',
        'title_english': 'The Puggalapaññatti',
        'page_start': 40,
        'layout': 'prose',
        'source_printed': 'อภิ.ปุ. 36/1-2-3',
        'group': 'General chanting',
        'english_unverified': True,
        'invitation': {
            'pali': '',
        ...
        'closing': {
            'pali': 'จบพระปุคคะละบัญญัติ',
            'pali_roman': '',
            'thai': 'จบพระปุคคะละบัญญัติ',
            'paiboon': 'jòp prá-púk-ká-lá-ban-yàt',
            'english': 'Here ends the Puggalapaññatti.',
        },
        'verses': [
            {
                'number': 1,
                'pali': 'ฉะ ปัญญัตติโย',
                'pali_roman': 'cha paññattiyo',
                'thai': '',
                'paiboon': '',
                'english': 'Six designations:',
            },
            {
                'number': 2,
                'pali': 'ขันธะปัญญัตติ,',
                'pali_roman': 'khandhapaññatti,',
                'thai': '',
                'paiboon': '',
                'english': 'the designation of aggregates,',
            },
            {
                'number': 3,
                'pali': 'อายะตะนะปัญญัตติ,',
                'pali_roman': 'āyatanapaññatti,',
                'thai': '',
                'paiboon': '',
                'english': 'the designation of sense bases,',
            },
            {
                'number': 4,
                'pali': 'ธาตุปัญญัตติ,',
                'pali_roman': 'dhātupaññatti,',
                'thai': '',
                'paiboon': '',
                'english': 'the designation of elements,',
            },
            {
                'number': 5,
                'pali': 'สัจจะปัญญัตติ,',
                'pali_roman': 'saccapaññatti,',
                'thai': '',
                'paiboon': '',
                'english': 'the designation of truths,',
            },
            {
                'number': 6,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'the designation of faculties,',
            },
            {
                'number': 7,
                'pali': 'ปุคคะละปัญญัตติ,',
                'pali_roman': 'puggalapaññatti,',
                'thai': '',
                'paiboon': '',
                'english': 'the designation of persons.',
            },
            {
                'number': 8,
                'pali': 'กิตตาวะตา ปุคคะลานัง ปุคคะละปัญญัตติ,',
                'pali_roman': 'kittāvatā puggalānaṃ puggalapaññatti,',
                'thai': '',
                'paiboon': '',
                'english': 'To what extent is there a designation of persons?',
            },
            {
                'number': 9,
                'pali': 'สะมะยะวิมุตโต อะสะมะยะวิมุตโต,',
                'pali_roman': 'samayavimutto asamayavimutto,',
                'thai': '',
                'paiboon': '',
                'english': 'One liberated on occasion, one not liberated on occasion,',
            },
            # ‼ CHECK [IMG_0303.PNG]: This pair is printed with a comma
            #   BETWEEN its two halves — กุปปะธัมโม, อะกุปปะธัมโม — where
            #   every other pair in the list runs its two halves together with
            #   no comma. Reproduced as printed rather than made uniform.
            {
                'number': 10,
                'pali': 'กุปปะธัมโม, อะกุปปะธัมโม,',
                'pali_roman': 'kuppadhammo, akuppadhammo,',
                'thai': '',
                'paiboon': '',
                'english': 'one liable to fall away, one not liable to fall away,',
            },
            {
                'number': 11,
                'pali': 'ปะริหานะธัมโม อะปะริหานะธัมโม,',
                'pali_roman': 'parihānadhammo aparihānadhammo,',
                'thai': '',
                'paiboon': '',
                'english': 'one subject to decline, one not subject to decline,',
            },
            {
                'number': 12,
                'pali': 'เจตะนาภัพโพ อะนุรักขะนาภัพโพ,',
                'pali_roman': 'cetanābhabbo anurakkhaṇābhabbo,',
                'thai': '',
                'paiboon': '',
                'english': 'one capable through volition, one capable through guarding,',
            },
            {
                'number': 13,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'the ordinary person, one of the change of lineage,',
            },
            # ‼ CHECK [IMG_0303.PNG]: Verses 14 and 15 each end with a full
            #   stop where the surrounding items end with commas, which is why
            #   the list is broken into three runs here. Reproduced as
            #   printed.
            {
                'number': 14,
                'pali': 'ภะยูปะระโต อะภะยูปะระโต.',
                'pali_roman': 'bhayūparato abhayūparato.',
                'thai': '',
                'paiboon': '',
                'english': 'one who abstains through fear, one who abstains not through fear.',
            },
            {
                'number': 15,
                'pali': 'ภัพพาคะมะโน อะภัพพาคะมะโน.',
                'pali_roman': 'bhabbāgamano abhabbāgamano.',
                'thai': '',
                'paiboon': '',
                'english': 'One capable of arriving, one incapable of arriving.',
            },
            {
                'number': 16,
                'pali': 'นิยะโต อะนิยะโต,',
                'pali_roman': 'niyato aniyato,',
                'thai': '',
                'paiboon': '',
                'english': 'One fixed in destiny, one not fixed in destiny,',
            },
            {
                'number': 17,
                'pali': 'ปะฏิปันนะโก ผะเลฏฐิโต,',
                'pali_roman': 'paṭipannako phaleṭṭhito,',
                'thai': '',
                'paiboon': '',
                'english': 'one practising the way, one established in the fruit,',
            },
            {
                'number': 18,
                'pali': 'อะระหา อะระหัตตายะ ปะฏิปันโน.',
                'pali_roman': 'arahā arahattāya paṭipanno.',
                'thai': '',
                'paiboon': '',
                'english': 'the Worthy One, and one practising for Worthiness.',
            },
        ],
    },
    {
        ...
        #   quotation marks that the book does not print — that is an
        #   editorial reading of the form, so it is worth your eye.
        'id': 'phra-kathawatthu',
        'title_thai': 'พระกะถาวัตถุ',
        'title_pali': '',
        'title_roman': 'prá-gà-tǎa-wát-tù',
        'title_english': 'The Kathāvatthu',
        'page_start': 40,
        'layout': 'prose',
        'group': 'General chanting',
        'english_unverified': True,
        ...
        'verses': [
            {
                'number': 1,
                'pali': 'ปุคคะโล อุปะลัพภะติ, สัจฉิกัตถะปะระมัตเถนาติ อามันตา.',
                'pali_roman': 'puggalo upalabbhati, sacchikatthaparamatthenāti āmantā.',
                'thai': '',
                'paiboon': '',
                'english': '"Is the person apprehended as a real and ultimate fact?" "Yes."',
            },
            {
                'number': 2,
                'pali': 'โย สัจฉิกัตโถ ปะระมัตโถ, ตะโต โส ปุคคะโล อุปะลัพภะติ, สัจฉิกัตถะปะระมัตเถนาติ.',
                'pali_roman': 'yo sacchikattho paramattho, tato so puggalo upalabbhati, sacchikatthaparamatthenāti.',
                'thai': '',
                'paiboon': '',
                'english': '"Is the person apprehended in the same way as that which is a real and ultimate fact?"',
            },
            # ‼ CHECK [IMG_0303.PNG]: The page ends mid-sentence after นะ, so
    ...
    },
    {
        ...
        'closing': {
            'pali': 'ระตะนัตตะยัปปะภาวะสิทธิคาถา นิฏฐิตา',
            'pali_roman': 'ratanattayappabhāvasiddhigāthā niṭṭhitā',
            'thai': '',
            'paiboon': '',
            'english': 'Here end the Verses on the accomplishing power of the Triple Gem.',
        },
        'verses': [
            ...
            # ‼ CHECK [IMG_0313.PNG]: TWO COLUMNS, continuing from page 49.
            #   First pairing on this page: left ปะริกขะกานะ ธีรานัง joined to
            #   right ญาณะสัญจาระณักขะมัง.
            {
                'number': 8,
                'page': 50,
                'pali': 'ปะริกขะกานะ ธีรานัง ญาณะสัญจาระณักขะมัง.',
                'pali_roman': 'parikkhakāna dhīrānaṃ ñāṇasañcāraṇakkhamaṃ.',
                'thai': '',
                'paiboon': '',
                'english': 'fit for the ranging of the knowledge of wise examiners.',
            },
            {
                'number': 9,
                'pali': 'ยัสสะ โลกัง ปะภาเสติ อาตะโปวะ ตะโมนุโท',
                'pali_roman': 'yassa lokaṃ pabhāseti ātapova tamonudo',
                'thai': '',
                'paiboon': '',
                'english': 'whose light shines upon the world like the sun dispelling darkness,',
            },
            {
                'number': 10,
                'pali': 'ทัยยะเทโส อิมาคัมมะ เขมะมัคคัปปะโชตะนัง.',
                'pali_roman': 'dayyadeso imāgamma khemamaggappajotanaṃ.',
                'thai': '',
                'paiboon': '',
                'english': 'the Thai land, having come to this, illuminating the path of safety.',
            },
            {
                'number': 11,
                'pali': 'สันติสุเข ปะติฏฐาติ อิสสะโร สาตะตัง ฐิโต',
                'pali_roman': 'santisukhe patiṭṭhāti issaro sātataṃ ṭhito',
                'thai': '',
                'paiboon': '',
                'english': 'stands established in the happiness of peace, sovereign and constant,',
            },
            {
                'number': 12,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'having honoured and guarded this foremost Triple Gem.',
            },
            {
                'number': 13,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'having made it the banner of the realm, raised up by the Thai land,',
            },
            {
                'number': 14,
                'pali': 'นีติปัญญัตติการายะ สะทิฏฐิยา ปะกุพพะเน.',
                'pali_roman': 'nītipaññattikārāya sadiṭṭhiyā pakubbane.',
                'thai': '',
                'paiboon': '',
                'english': 'for the making of law and ordinance, acting according to right view.',
            },
            {
                'number': 15,
                'pali': 'ธัมมะนุญญัง วะ รัฏฐัสสะ รัฏฐานัง สิทธิทายะกัง',
                'pali_roman': 'dhammanuññaṃ va raṭṭhassa raṭṭhānaṃ siddhidāyakaṃ',
                'thai': '',
                'paiboon': '',
                'english': "as the Dhamma's sanction for the realm, giver of success to the realms,",
            },
            {
                'number': 16,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'and having so made the Sangha sovereign in the affairs of the dispensation.',
            },
            # ‼ CHECK [IMG_0313.PNG]: THE ONE ROW ON THIS PAGE THAT IS NOT
            #   JOINED BY A SPACE. The left column ends พุทธะ- with a hyphen
            #   and the right column begins สาสะนัสสะ, so the word
            #   พุทธะสาสะนัสสะ is broken across the GUTTER rather than across
            #   a line. The two halves are joined with no space and the hyphen
            #   dropped, because it is typesetting; every other row on this
            #   page joins with a single space. Worth confirming, since it is
            #   the only place the two-column rule and the rejoin-a-hyphen
            #   rule meet.
            {
                'number': 17,
                'pali': 'ปะสิชฌะนันติทัง พุทธะสาสะนัสสะ ปะสาสะนัง',
                'pali_roman': 'pasijjhanantidaṃ buddhasāsanassa pasāsanaṃ',
                'thai': '',
                'paiboon': '',
                'english': "these succeed — this governance of the Buddha's dispensation —",
            },
            {
                'number': 18,
                'pali': 'เอวัง ปะสาสะนุปาเยนะ ถิรัง ติฏฐะติ สาสะนัง.',
                'pali_roman': 'evaṃ pasāsanupāyena thiraṃ tiṭṭhati sāsanaṃ.',
                'thai': '',
                'paiboon': '',
                'english': 'and by such means of governance the dispensation stands firm.',
            },
            # ‼ CHECK [IMG_0313.PNG]: Verses 19 and 27 are printed INDENTED
            #   from the left margin, where every other row starts flush. The
            #   indent marks a new movement of the chant — both begin
            #   ระตะนัตตะย… and turn from the dispensation to a wish for the
            #   nation. Recorded here because the indent is not carried in the
            #   data; there is no field for it, and nothing is lost from the
            #   words themselves.
            {
                'number': 19,
            ...
            {
                'number': 20,
                'pali': 'ทัยยะชาติ วิโรเจตุ สัพพะสัมปัตติสิทธิยา.',
                'pali_roman': 'dayyajāti virocetu sabbasampattisiddhiyā.',
                'thai': '',
                'paiboon': '',
                'english': 'may the Thai nation shine with the attainment of every good fortune.',
            },
            {
                'number': 21,
                'pali': 'อิทธิง ปัปโปตุ เวปุลลัง วิรุฬหิง จุตตะริง สะทา',
                'pali_roman': 'iddhiṃ pappotu vepullaṃ viruḷhiṃ cuttariṃ sadā',
                'thai': '',
                'paiboon': '',
                'english': 'May it reach success, abundance, growth and advancement always,',
            },
            {
                'number': 22,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'and long may the dispensation of the Perfectly Enlightened One stand in the world.',
            },
            {
                'number': 23,
                'pali': 'ทัสเสนตัง ภัพพะสัตตานัง อัญชะสัง วะ วิสุทธิยา',
                'pali_roman': 'dassentaṃ bhabbasattānaṃ añjasaṃ va visuddhiyā',
                'thai': '',
                'paiboon': '',
                'english': 'showing to beings capable of it the straight way to purity.',
            },
            {
                'number': 24,
                'pali': 'จิรัญชีวะตุ ทีฆายุ ทัยยานัง ธัมมะขัตติโย.',
                'pali_roman': 'cirañjīvatu dīghāyu dayyānaṃ dhammakhattiyo.',
                'thai': '',
                'paiboon': '',
                'english': "Long may he live, of long life, the Thais' righteous sovereign.",
            },
            {
                'number': 25,
                'pali': 'วัณณะวา พะละสัมปันโน นิรามะโย จะ นิพภะโย.',
                'pali_roman': 'vaṇṇavā balasampanno nirāmayo ca nibbhayo.',
                'thai': '',
                'paiboon': '',
                'english': 'Fair of form, endowed with strength, free from illness and from fear.',
            },
            {
                'number': 26,
                'pali': 'รัฏฐัสสะ ธัมมะนุญญัญจะ จิรัง ติฏฐะตุ โสตถินา.',
                'pali_roman': 'raṭṭhassa dhammanuññañca ciraṃ tiṭṭhatu sotthinā.',
                'thai': '',
                'paiboon': '',
                'english': "And long may the Dhamma's sanction for the realm stand in safety.",
            },
            {
                'number': 27,
                'pali': 'ระตะนัตตะยัปปะภาเวนะ วุฑฒิยาสา สะมิชฌะตุ',
                'pali_roman': 'ratanattayappabhāvena vuḍḍhiyāsā samijjhatu',
                'thai': '',
                'paiboon': '',
                'english': 'By the power of the Triple Gem may the hope of growth be fulfilled,',
            },
            {
                'number': 28,
                'pali': 'ทัยยานัง รัฏฐะปาลีนัง สัพพะสิทธิ สะทา ถิรัง.',
                'pali_roman': 'dayyānaṃ raṭṭhapālīnaṃ sabbasiddhi sadā thiraṃ.',
                'thai': '',
                'paiboon': '',
                'english': 'and for the Thais who guard the realm, may every success be lasting.',
            },
            {
                'number': 29,
                'pali': 'ชะยะมัตถุ จะ ทัยยานัง วุฑฒิ สันติ นิรันตะรัง',
                'pali_roman': 'jayamatthu ca dayyānaṃ vuḍḍhi santi nirantaraṃ',
                'thai': '',
                'paiboon': '',
                'english': 'May there be victory for the Thais, growth and peace unbroken,',
            },
            {
                'number': 30,
                'pali': 'ปะวัฑฒะตัง จะ ภิยโยโส ธะนุฏฐาเนนะ สัมปะทาติ.',
                'pali_roman': 'pavaḍḍhataṃ ca bhiyyoso dhanuṭṭhānena sampadāti.',
                'thai': '',
                'paiboon': '',
                'english': 'and may prosperity increase yet further through wealth and endeavour.',
            },
        ],
    },
    {
    ...
    },
    {
        ...
        'verses': [
            ...
            # ‼ CHECK [IMG_0316.PNG]: The book prints an alternative INSIDE
            #   the line, in brackets: วันทันโตหัง (ตีหัง). It is not a
            #   footnote and has no marker, so it is reproduced inline exactly
            #   as printed rather than put in the variants field. It looks
            #   like the feminine form — vandantī'haṃ for a woman where
            #   vandanto'haṃ is for a man — but nothing on the page says so,
            #   and Josh should confirm what the brackets are offering before
            #   anything is built on it.
            {
                'number': 10,
                'page': 53,
                'pali': 'วันทันโตหัง (ตีหัง) จะริสสามิ พุทธัสเสวะ สุโพธิตัง.',
                'pali_roman': 'Vandantohaṃ (tīhaṃ) carissāmi buddhasseva subodhitaṃ.',
                'thai': '',
                'paiboon': '',
                'english': "Revering him, I shall walk on by the Buddha's own true awakening.",
            },
            {
                'number': 11,
                ...
                'thai': '',
                'paiboon': '',
                'english': 'For me there is no other refuge; the Buddha is my refuge, the best of them.',
            },
            {
                'number': 12,
            ...
            {
                'number': 13,
                'pali': 'พุทธัง เม วันทะมาเนนะ ยัง ปุญญัง ปะสุตัง อิธะ',
                'pali_roman': 'Buddhaṃ me vandamānena yaṃ puññaṃ pasutaṃ idha',
                'thai': '',
                'paiboon': '',
                'english': 'Whatever merit I have gained here in revering the Buddha —',
            },
            # ‼ CHECK [IMG_0316.PNG]: The rubric
            #   หมอบลงพร้อมกันแล้วสวดลดเสียงเบาลง ดังนี้. is printed between
            #   verse 14 and verse 15, inside the chant. It is carried on
            #   verse 14 as its rubric, which the template renders under that
            #   line — the same way page 1 handles (กราบพร้อมกัน). A page
            #   block could not be used: those can only sit between whole
            #   chants.
            {
                'number': 14,
            ...
            # ‼ CHECK [IMG_0316.PNG]: Verses 15-18 are the same four lines the
            #   app already holds on page 14 as kham-kho-khama-phra-
            #   rattanatrai verses 1-4, but page 53 prints a COMMA at the end
            #   of each of the first three and page 14's entry has none. Both
            #   are entered as their page prints them. Worth one look at page
            #   14 in the book to see whether the difference is the book's or
            #   the app's.
            {
                'number': 15,
                'pali': 'กาเยนะ วาจายะ วะ เจตะสา วา,',
    ...
    },
    {
        # ‼ COMMENTARY PENDING: set DATA-ONLY. background, meaning, summary,
        #   when_chanted and source still to be written. Verses are complete.
        # ‼ CHECK [IMG_0316.PNG]: The book prints NO title for this passage.
        #   The id and the English title come from the name the rubric above
        #   it gives it — พระธรรมคุณ, the qualities of the Dhamma. Same
        #   treatment as page 52's พระพุทธคุณ.
        # ‼ CHECK [IMG_0316.PNG]: This is not the same text as the app's
        #   dhammabhithuti (page 2), which opens โย โส ส๎วากขาโต and runs to
        #   ตะมะหัง ธัมมัง สิระสา นะมามิ. Page 53's passage is the plain
        #   recollection of the Dhamma's qualities, with no โย โส and no
        #   closing salutation. Entered as its own chant.
        'id': 'phra-thammakhun',
        'title_thai': '',
        'title_pali': '',
        'title_roman': '',
        'title_english': 'The Qualities of the Dhamma',
        'page_start': 53,
        'layout': 'prose',
        'group': 'General chanting',
        'english_unverified': True,
        ...
        'verses': [
            # ‼ CHECK [IMG_0316.PNG]: ส์วากขาโต again, and this is now the
            #   FOURTH place the app holds this word: plain สวากขาโต on page
            #   1, ส์วากขาโต here and on page 51, and ส๎วากขาโต with U+0E4E in
            #   dhammabhithuti on page 2. Page 53 prints the same small mark
            #   over the ส that page 51 does, so it is entered the same way.
            #   One look at the book settles all four at once, and this is a
            #   chanted line.
            {
                'number': 1,
            ...
            {
                'number': 2,
                'pali': 'สันทิฏฐิโก อะกาลิโก เอหิปัสสิโก,',
                'pali_roman': 'Sandiṭṭhiko akāliko ehipassiko,',
                'thai': '',
                'paiboon': '',
                'english': 'visible here and now, timeless, inviting all to come and see,',
            },
            {
                'number': 3,
                'pali': 'โอปะนะยิโก ปัจจัตตัง เวทิตัพโพ วิญญูหีติ.',
                'pali_roman': 'Opanayiko paccattaṃ veditabbo viññūhīti.',
                'thai': '',
                'paiboon': '',
                'english': 'leading onwards, to be known each for himself by the wise.',
            },
        ],
    },
    {
        ...
        #   สัพพะปาณีนัง + right cell สะระณัง เขมะมุตตะมัง.
        # ‼ CHECK [IMG_0316.PNG]: The book prints NO title for this chant. The
        #   rubric above it names it ธัมมาภิคีติ (Dhammābhigīti), and that is
        #   where the id comes from. Same treatment as พุทธาภิคีติ on page 52.
        # ‼ CHECK [IMG_0316.PNG]: The chant's invitation หันทะ มะยัง
        #   ธัมมาภิคีติง กะโรมะ เส. is printed inside the prose rubric, not as
        #   a line of its own. Kept in the page block only, so it prints once.
        #   Same decision as พุทธาภิคีติ on page 52 — if Josh wants it in the
        #   invitation field as well, that is a choice, not a fix.
        'id': 'dhammabhigiti',
        'title_thai': '',
        'title_pali': '',
        'title_roman': '',
        'title_english': 'The Hymn to the Dhamma',
        'page_start': 53,
        'group': 'General chanting',
        'english_unverified': True,
        'invitation': {
        ...
        'verses': [
            # ‼ CHECK [IMG_0316.PNG]: ส์วากขาตะตาทิ- is transliterated
            #   svākkhātatādi-, following the mark the book prints over the ส.
            ...
            # ‼ CHECK [IMG_0316.PNG]: ตะทะธาริธารี is an unusual compound and
            #   the English given for it — "holds up those who hold to it" —
            #   is a working reading, not a settled one. Standard editions
            #   have tadadhāridhārī with the same sense, but this line is
            #   worth Josh's eye more than most on the page.
            {
                'number': 3,
            ...
            # ‼ CHECK [IMG_0316.PNG]: The last line on the page. It is a
            #   COMPLETE two-pāda line, not a cut one, but ends without
            #   punctuation because the sentence finishes on page 54. The
            #   chant is marked as continuing; page 54's batch adds verse 8
...
PAGE_BLOCKS = [
    ...
    # ── Page 53 ────────────────────────────────────────────────────
    # Written from batch-053-053.json.
    {
        'page': 53,
        'after': 'buddhabhigiti',
        'blocks': [
            {
                'type': 'prose',
                'thai': 'เงยขึ้นพร้อมกัน แล้วประธานกล่าวเชิญชวนสวดพระธรรมคุณ ว่า หันทะ มะยัง ธัมมานุสสะตินะยัง กะโรมะ เส. รองประธานขึ้นต้นบทว่า ส์วากขาโต นอกนั้นรับต่อ ภะคะวะตา ธัมโม ฯเปฯ พร้อมกันไป หยุดตามจุดลูกน้ำ ดังนี้.',
                'english': 'Raise the head, together. Then the leader gives the invitation to chant the qualities of the Dhamma, saying: Handa mayaṃ dhammānussatinayaṃ karoma se. The deputy leader begins the passage with Svākkhāto, and the rest take it up from Bhagavatā dhammo and so on, going on together, pausing at each comma, thus.',
                'english_unverified': True,
            },
        ],
    },
